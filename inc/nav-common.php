...
<header class="cabecalho">
    <div class="logo">
        <img src="/assets/images/logo.svg" id="logo-login-header" alt="logo-login-pontus"/>
    </div>
</header>
<header>
        ...
        <div class="itensVerticalGroup">
            ...
            if($_SESSION['tipo_acesso_usuario'] == 'C'):?>
                <div class="itemVerticalMenu">
                    ...
                    <a href="/views/sistema_ponto.php">     
